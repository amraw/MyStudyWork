...
public class Choice
{
    ...
    public int compareWith(Choice anotherChoice)
    {
        ...
        {
            case 0:
                   if(anotherChoice.type==0)
                   result=0;
                   else if(anotherChoice.type==1)
                   result=-1;
                   else
                   result=1;
                   break;
    ...
    public void draw(Canvas canvas, int x, int y, int rotation)
    {
       ...
       {
           case 0:
                 ColorImage rock=new ColorImage("rock.png");
                 rock.setX(x);
                 rock.setY(y);
                 ...
                 break;
           case 1:
                 ColorImage paper=new ColorImage("paper.png");
                 paper.setX(x);
                 paper.setY(y);
                 ...
                 break;
           case 2:
                 ColorImage scissors=new ColorImage("scissors.png");
                 scissors.setX(x);
                 scissors.setY(y);
                 scissors.setRotation(rotation);
                 canvas.add(scissors);
                 break;
